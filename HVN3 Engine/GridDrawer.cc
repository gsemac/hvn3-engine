...
namespace hvn3 {
	namespace Drawing {
		...
		GridDrawer::GridDrawer(Graphics& graphics) :
			_graphics(graphics) {
		}

		void GridDrawer::DrawGrid(const Point2d<float>& position, const Grid& grid) {

			DrawGrid(position, grid, Color::Black);

		}
		void GridDrawer::DrawGrid(const Point2d<float>& position, const Grid& grid, const Color& grid_color) {
		...
		void GridDrawer::DrawGrid(const Point2d<float>& position, const Grid& grid, const Color& grid_color, const Color& cell_color) {
