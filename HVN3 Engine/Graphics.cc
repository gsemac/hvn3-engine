...
namespace hvn3 {
	...
	namespace Drawing {
		...
		void Graphics::DrawText(float x, float y, const char* text, const Font* font, const Color& color, Alignment alignment) {
			...
			al_draw_text(System::AllegroAdapter::FromFont(*font), System::AllegroAdapter::ToColor(color), x, y, GetAllegroFlags(alignment), text);
		...
		void Graphics::DrawText(float x, float y, const String& text, const Font* font, const Color& color, Alignment alignment) {
			...
			al_draw_ustr(System::AllegroAdapter::FromFont(*font), System::AllegroAdapter::ToColor(color), x, y, GetAllegroFlags(alignment), text.AlPtr());
