...
namespace GUI {
	...
	public:
		...
		void OnPaint(PaintEventArgs& e) override {
			...
			// Draw titlebar.
			e.Graphics().DrawFilledRectangle(0, 0, Width(), __titlebar_height, BackColor());
			e.Graphics().DrawRectangle(0, 0, Width(), __titlebar_height, Color(17, 17, 17), 1);

			// Draw titlebar text.
			float tx = Round(Width() / 2.0f);
			float ty = Round((__titlebar_height / 2.0f) - (__font->Height() / 2.0f)) - 1;
			...
			e.Graphics().DrawFilledRectangle(0, __titlebar_height, Width(), Height(), BackColor());
		...
		/*	e.Graphics().SetDrawingTarget(__child_bitmap.AlPtr());
			...
			e.Graphics().DrawRectangle(0, __titlebar_height, Width(), Height(), Color(17, 17, 17), 1);
