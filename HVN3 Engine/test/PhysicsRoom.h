...
class DynamicBox : public hvn3::Object {
public:
	DynamicBox(float x, float y) : Object(1, hvn3::PointF(x, y)) {}
	void OnCreate(hvn3::CreateEventArgs& e) override {
		_collision_body = GameState.Collisions().CreateBody(this);
		_collision_body->SetHitMask(hvn3::Collision::RectangleHitMask::Create(hvn3::RectangleF(32.0f, 32.0f)));
...
public:
	...
	void OnCreate(hvn3::CreateEventArgs& e) override {
		_collision_body = GameState.Collisions().CreateBody(this);
		_collision_body->SetHitMask(hvn3::Collision::RectangleHitMask::Create(hvn3::RectangleF(512.0f, 16.0f)));
...
class PhysicsRoom : public hvn3::Room {
public:
	PhysicsRoom() : hvn3::Room(1, hvn3::SizeI(640, 480)) {}
	void OnUpdate(hvn3::UpdateEventArgs& e) override {
		Room::OnUpdate(e);
		...
		if (hvn3::Mouse::ButtonPressed(hvn3::MouseButton::Left))
			Objects()->AddInstance(hvn3::Object::Create<DynamicBox>(hvn3::Mouse::X, hvn3::Mouse::Y));
	}
protected:
	void OnSetUp() override {
		...
		Objects()->AddInstance(hvn3::Object::Create<StaticBox>(64.0f, 400.0f));
	}
};