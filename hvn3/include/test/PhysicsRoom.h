...
//		_collision_body->SetHitMask(hvn3::HitMaskPtr(new hvn3::RectangleHitMask(hvn3::RectangleF(32.0f, 32.0f))));
...
//	hvn3::CollisionBodyHandle _collision_body;
//
//};
//
...
//	void OnCreate(hvn3::CreateEventArgs& e) override {
//		_collision_body = GameState.Collisions()->CreateBody(this);
//		_collision_body->SetHitMask(hvn3::HitMaskPtr(new hvn3::RectangleHitMask(hvn3::RectangleF(512.0f, 16.0f))));
...
//private:
//	hvn3::Physics::IPhysicsBody* _physics_body;
//	hvn3::ICollisionBody* _collision_body;
//};
//
//class PhysicsRoom : 
//	public hvn3::Room {
