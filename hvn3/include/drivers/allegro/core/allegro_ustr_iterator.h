...
namespace hvn3::allegro {
	...
	using al_ustr_reverse_iterator = hvn3::iterators::ReverseIterator<AllegroUstrIterator<false>>;
	using al_ustr_const_reverse_iterator = hvn3::iterators::ReverseIterator<AllegroUstrIterator<true>>;
