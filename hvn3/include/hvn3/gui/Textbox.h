...
namespace hvn3 {
	...
	namespace Gui {
		...
		public:
			Textbox(float x, float y, float width, float height) : Control(PointF(x, y), SizeF(width, height)),
				__caret(this),
				__sel(0, 0),
