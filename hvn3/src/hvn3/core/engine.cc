...
namespace hvn3::core {
	...
	Engine::ref_count_type Engine::coreRefCount = 0;
	Engine::ref_count_type Engine::ioRefCount = 0;
	Engine::ref_count_type Engine::graphicsRefCount = 0;
	Engine::ref_count_type Engine::audioModuleRefCount = 0;
